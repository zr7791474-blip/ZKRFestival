...
const WarpText = ({
  ...
  useEffect(() => {
    ...
    // Mark WebGL as ready after first successful render
  ...
  if (!webglReady) {
    return (
      <div
        className={`relative block w-full ${className}`.trim()}
        style={{
          ...style,
          fontSize: fontSize || 'clamp(3rem, 10vw, 9rem)',
          fontWeight: fontWeight || 800,
          fontFamily: fontFamily || 'inherit',
          letterSpacing: letterSpacing || '-0.06em',
          lineHeight: String(lineHeight || 0.9),
          color: color || '#f8f5ff',
          textAlign: 'center',
        }}
        role="heading"
